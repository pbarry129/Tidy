...
# Merge these files into one activity files
...
# We now read in the feature data for the test group
...
# complete the data file by including the activity labels

data_mean_std<-merge(x=data_mean_std, y=activity_labels, by="activityid")

# Remove the now redundant activityid column
...
# Now use text operators to clean up the names
# ASSIGNMENT 3
...
# We could make "subject" more verbose for readability with
